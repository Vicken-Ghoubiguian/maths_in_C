...
// Recursive function to calculate square root of an int named 'a' by the Heron's method
...
// Iterative function to calculate square root of an int named 'a' by the Heron's method
